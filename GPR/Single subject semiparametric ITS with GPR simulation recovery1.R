#Recovery1: checking parameter recovery rate by correlation
...
stan_model_obj <- stan_model(file = "Stan Model/Single subject semiparametric ITS with GPR simulation recovery1.stan")
